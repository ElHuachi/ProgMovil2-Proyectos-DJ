...
data class EnvelopeCalifUnidad @JvmOverloads constructor(
    @field:Element(name = "Body", required = false)
    var bodyCaliUnidad: BodyCalifUnidad = BodyCalifUnidad()
)

@Root(name = "Body", strict = false)
data class BodyCalifUnidad @JvmOverloads constructor(
