...
fun RowUser(
    ...
    Row(
        ...
        OutlinedTextField(
            value = user.toUpperCase(), // Convertir la cadena a mayúsculas
            onValueChange = { newUser ->
                userChange(newUser.toUpperCase()) // Convertir la cadena a mayúsculas antes de asignarla
            },
            label = { Text("Usuario") },
                ...
                if(checkInternetConnection(context)){
                    ...
                    if(viewModel.accesoLoginResult?.acceso==true) {
                        ...
                        coroutineScope.launch {
                            viewModel.deleteAccessDB(nControl)
